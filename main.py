...
Заявки принимаются и обрабатываются в этот же день. Если у вас нет ИИН (налоговый номер Казахстана), то ниже есть контакт менеджера для получения. 

По ссылке  из смс сообщения вам нужно пройти процесс регистрации в приложении банка, а также верификацию с загранпаспортом (видео звонок с сотрудником банка), открыть счет, далее заказать доставку карты по удобному для вас адресу. Получить карту сможете ТОЛЬКО ВЫ лично в руки. 
...
- Дата рождения
- Номер телефона
- Номер ИИН Казахстана (если его у вас нет, наш менеджер поможет вам его оформить @PFL2024)
